...
int main(int argc, const char * argv[]) {
    ...
    NSArray* array1 = @[@100, @4, @200, @1, @3, @2];
    SequenceClass* sequence = [[[SequenceClass alloc]initArray:array1] autorelease];
    [sequence longestSequenceInArray:1];
    
    NSArray* array2 = @[@503, @505, @587, @656, @766, @1485, @1939, @2264, @2780, @2813, @2900, @3083, @3118, @3379,
    ...
    SequenceClass* sequence2 = [[[SequenceClass alloc]initArray:array2] autorelease];
    
    NSArray* array3 = @[@155, @192, @345, @393, @480, @598, @660, @722, @724, @772, @776, @782, @818, @839, @936,
                       @1046, @1066, @1271, @1290, @1314, @1324, @1345, @1352, @438, @1443, @1456, @1518, @1645,
                       ...
                       @9489, @9527, @9528, @9630, @9674, @9869, @9968];
    
    SequenceClass* sequence3 = [[[SequenceClass alloc]initArray:array3] autorelease];
    [sequence3 longestSequenceInArray:2];
